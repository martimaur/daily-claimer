...
1. **Clone or Download**:
   ...
   - You can also download the latest release as a zip file [here](https://github.com/martimaur/daily-claimer/releases/download/v1.0.0/HellCaseBot_firstRelease.zip).
